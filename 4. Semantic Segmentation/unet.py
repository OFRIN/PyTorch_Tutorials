...
class UNet(nn.Module):
    def __init__(self, image_channels, classes):
        super().__init__()

        self.image_channels = image_channels
        self.classes = classes

        self.block = Double_Conv_Block(self.image_channels, 64, 64)
        
        self.down_block_1 = Down_Block(64, 128, 128)
        self.down_block_2 = Down_Block(128, 256, 256)
        self.down_block_3 = Down_Block(256, 512, 512)
        self.down_block_4 = Down_Block(512, 1024, 1024)

        self.up_block_1 = Up_Block(1024, 512, 512)
        self.up_block_2 = Up_Block(512, 256, 256)
        self.up_block_3 = Up_Block(256, 128, 128)
        self.up_block_4 = Up_Block(128, 64, 64)
        
        self.classifier = nn.Conv2d(in_channels=64, out_channels=self.classes, kernel_size=3, stride=1, padding=1)
