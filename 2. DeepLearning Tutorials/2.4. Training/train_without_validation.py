...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=16, num_workers=0, shuffle=True, pin_memory=False, drop_last=True)

    valid_dataset = Single_Classification_Dataset(root_dir, test_transforms, './data/validation.json', ['dog', 'cat'])
    valid_loader = DataLoader(valid_dataset, batch_size=16, num_workers=0, shuffle=False, pin_memory=False, drop_last=False)
