...
style_image = cv2.imread('./style_image/BORI_texture.png')
content_image = cv2.imread('./content_image/SSAL.jpg')

style_image = train_transforms(style_image)
content_image = train_transforms(content_image)
...
output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std, content_image, style_image, generated_image)
